...
export const Sidebar = () => {
	return (
		<aside className='w-[260px] h-screen bg-white flex flex-col fixed left-0 top-0 overflow-y-auto custom-scrollbar'>
			{/* 1. Logo Section */}
			<div className='flex items-center justify-center h-20 shrink-0'>
				...
				>
					<span className='text-[rgb(72,128,255)]'>Dash</span>
